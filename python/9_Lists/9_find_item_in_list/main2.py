# Complete the loop inside check_character_levels. It already loops over all of the indexes i in
# old_character_levels. The old_character_levels and new_character_levels lists are the same length, which means you can use i to index into both.
