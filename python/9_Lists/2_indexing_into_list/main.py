...
# We access items in a list directly by using their index. Indexes start at 0
# (the first item) and increment by one with each successive item. The syntax is as follows:
